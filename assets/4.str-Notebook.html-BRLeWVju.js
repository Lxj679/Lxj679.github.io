...
<span class="token comment"># output</span>
<span class="token number">12</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_10-2-input-使用输入提示" tabindex="-1"><a class="header-anchor" href="#_10-2-input-使用输入提示"><span>10.2 input() 使用输入提示</span></a></h3><p>但是上面的代码，有点小问题：在运行的时候并不能很直观的知道程序是否需要我们输入</p><figure><img src="`+u+`" alt="image-20240407112955858" tabindex="0" loading="lazy"><figcaption>image-20240407112955858</figcaption></figure><p>如何解决这个问题？————使用输入提示。</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code>user_input <span class="token operator">=</span> <span class="token builtin">input</span><span class="token punctuation">(</span><span class="token string">&quot;enter your name:&gt;&gt;&gt;&quot;</span><span class="token punctuation">)</span>
<span class="token keyword">print</span><span class="token punctuation">(</span>user_input<span class="token punctuation">)</span>

<span class="token comment"># output</span>
enter your name<span class="token punctuation">:</span><span class="token operator">&gt;&gt;</span><span class="token operator">&gt;</span> name
 name
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+d+'" alt="image-20240407113109817" tabindex="0" loading="lazy"><figcaption>image-20240407113109817</figcaption></figure><h3 id="_10-3-input-的特点" tabindex="-1"><a class="header-anchor" href="#_10-3-input-的特点"><span>10.3 input() 的特点</span></a></h3><h4 id="_10-3-1-input-得到的类型是字符串-str" tabindex="-1"><a class="header-anchor" href="#_10-3-1-input-得到的类型是字符串-str"><span>10.3.1 input() 得到的类型是字符串（str）</span></a></h4><figure><img src="'+k+'" alt="image-20240407114036685" tabindex="0" loading="lazy"><figcaption>image-20240407114036685</figcaption></figure><p>通过上方的代码示例，我们可以知道：通过<code>input()</code>输入，得到的类型都将是字符串，然而用户输入的数据往往都是其他类型，那么我们又该如何保留输入原有的类型呢？</p><h4 id="_10-3-2-input输入类型转换" tabindex="-1"><a class="header-anchor" href="#_10-3-2-input输入类型转换"><span>10.3.2 input输入类型转换</span></a></h4><ol><li>强制类型转换</li></ol><p>部分类型可以强制转换：</p><figure><img src="'+v+'" alt="image-20240407115607825" tabindex="0" loading="lazy"><figcaption>image-20240407115607825</figcaption></figure><p>然而有一些类型转换后会出现问题，例如列表（list）：</p><figure><img src="'+m+'" alt="这样看好像没有问题" tabindex="0" loading="lazy"><figcaption>这样看好像没有问题</figcaption></figure><p>强制转换会把每一个字符拆开</p><figure><img src="'+b+`" alt="输出的结果却出了问题" tabindex="0" loading="lazy"><figcaption>输出的结果却出了问题</figcaption></figure><p>：：： tips</p><p>哪一些可以强制转换呢？</p><p>————int 、float、 bool、 str 可以，其他不行</p><p>：：：</p><ol start="2"><li>eval()</li></ol><p>通过该函数将输入转为原有类型</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code>In <span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">]</span><span class="token punctuation">:</span> s <span class="token operator">=</span> <span class="token builtin">eval</span><span class="token punctuation">(</span><span class="token builtin">input</span><span class="token punctuation">(</span><span class="token string">&#39;:&gt;&gt;&gt;&#39;</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
