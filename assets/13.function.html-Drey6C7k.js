import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,a as t}from"./app-B6Vc-suT.js";const p={},e=t(`<h2 id="_1-函数的定义" tabindex="-1"><a class="header-anchor" href="#_1-函数的定义"><span>1. 函数的定义</span></a></h2><p>计算机中的函数————代码片段</p><ul><li>一段具有特定功能的、可重复使用的代码</li><li>用函数名来表示并通过函数名来完成功能调用</li></ul><h2 id="_2-使用函数的意义" tabindex="-1"><a class="header-anchor" href="#_2-使用函数的意义"><span>2. 使用函数的意义</span></a></h2><ul><li>代码的重复利用</li><li>减少程序中的代码重复量，使代码更加容易被理解；</li><li>让代码更易于维护与更新</li></ul><h2 id="_3-函数的使用" tabindex="-1"><a class="header-anchor" href="#_3-函数的使用"><span>3. 函数的使用</span></a></h2><ol><li>内置函数：</li></ol><ul><li>Python 编程语言中已经被定好功能的函数</li><li>可以直接调用来执行特定的任务</li></ul><ol start="2"><li>用户自定义函数</li></ol><ul><li>函数功能和使用方法都由用户决定</li></ul><h3 id="_3-1-使用一个函数" tabindex="-1"><a class="header-anchor" href="#_3-1-使用一个函数"><span>3.1 使用一个函数</span></a></h3><ul><li>python 中有许多的内置函数，我们可以直接使用他们，</li></ul><p>​ 如：</p><p>​ 输出函数 print()</p><p>​ 获取用户输入的函数 input()</p><p>​ 类型转换的函数 int() float() str()……</p><p>​ 除了内置函数外，Python还有内置的标准函数库</p><ul><li>当我们把这些额外函数库导入我们程序里时，我们可以用这些函数库提供的方法</li></ul><p>​ 访问这些函数时需要以<strong>库名.函数名</strong>的方式来使用</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> math
