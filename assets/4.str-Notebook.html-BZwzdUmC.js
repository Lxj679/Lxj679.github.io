...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,14),k=i(`<p>有时候我们需要字符串里面有单引号或双引号，此时发挥作用：**<span style="color:orange;">单双引号混用，是第一个原因</span>**那么三引号呢？ 假设我们现在需要存储如下文本：</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code>我们有时候不仅仅要看选择项以内的答案，也要去思考选择项以外的答案。——AI悦创
...
bnri
ofts
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,18);function f(x,q){const l=o("CodeTabs");return c(),r("div",null,[b,n("ul",null,[n("li",null,[k,d(l,{id:"43",data:[{id:"单引号"},{id:"双引号"}]},{title0:a(({value:e,isActive:t})=>[s("单引号")]),title1:a(({value:e,isActive:t})=>[s("双引号")]),tab0:a(({value:e,isActive:t})=>[g]),tab1:a(({value:e,isActive:t})=>[y]),_:1})]),h]),_])}const I=p(m,[["render",f],["__file","4.str-Notebook.html.vue"]]),P=JSON.parse(`{"path":"/Notability/python/4.str-Notebook.html","title":"str Notebook","lang":"zh-CN","frontmatter":{"title":"str Notebook","date":"2024-03-29T15:25:42.000Z","isOriginal":true,"category":["python"],"tag":["python","编程","教程"],"icon":"python","sticky":false,"star":false,"article":true,"timeline":true,"image":false,"navbar":true,"sidebarIcon":true,"headerDepth":5,"comment":true,"lastUpdated":true,"editLink":true,"backToTop":true,"toc":true,"description":"1. 字符串的定义 字符串是由字母、数字和特殊字符来组成的序列 a4034a755a9502dce168bbee003b2cca4034a755a9502dce168bbee003b2cc 2. 创建字符串 如何创建字符串？ ————使用** 单引号、双引号或者 三引号**。 为什么Python同时支持三种创建字符串的方法 但是英文当中可以缩写如下： ...","head":[["meta",{"property":"og:url","content":"https://dailyrecord4ryan.com/Notability/python/4.str-Notebook.html"}],["meta",{"property":"og:site_name","content":"Website of Ryan"}],["meta",{"property":"og:title","content":"str Notebook"}],["meta",{"property":"og:description","content":"1. 字符串的定义 字符串是由字母、数字和特殊字符来组成的序列 a4034a755a9502dce168bbee003b2cca4034a755a9502dce168bbee003b2cc 2. 创建字符串 如何创建字符串？ ————使用** 单引号、双引号或者 三引号**。 为什么Python同时支持三种创建字符串的方法 但是英文当中可以缩写如下： ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-04-01T03:57:51.000Z"}],["meta",{"property":"article:author","content":"Ryan"}],["meta",{"property":"article:tag","content":"python"}],["meta",{"property":"article:tag","content":"编程"}],["meta",{"property":"article:tag","content":"教程"}],["meta",{"property":"article:published_time","content":"2024-03-29T15:25:42.000Z"}],["meta",{"property":"article:modified_time","content":"2024-04-01T03:57:51.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"str Notebook\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2024-03-29T15:25:42.000Z\\",\\"dateModified\\":\\"2024-04-01T03:57:51.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Ryan\\",\\"url\\":\\"https://dailyrecord4ryan.com\\"}]}"]]},"headers":[{"level":2,"title":"1. 字符串的定义","slug":"_1-字符串的定义","link":"#_1-字符串的定义","children":[]},{"level":2,"title":"2. 创建字符串","slug":"_2-创建字符串","link":"#_2-创建字符串","children":[]},{"level":2,"title":"3. 字符串长度","slug":"_3-字符串长度","link":"#_3-字符串长度","children":[]},{"level":2,"title":"4. 字符串中的字符获取","slug":"_4-字符串中的字符获取","link":"#_4-字符串中的字符获取","children":[{"level":3,"title":"4.1 获取单个字符","slug":"_4-1-获取单个字符","link":"#_4-1-获取单个字符","children":[]},{"level":3,"title":"4.2 获取多个连续字符（子字符串）","slug":"_4-2-获取多个连续字符-子字符串","link":"#_4-2-获取多个连续字符-子字符串","children":[]},{"level":3,"title":"4.3 获取多个不连续的字符","slug":"_4-3-获取多个不连续的字符","link":"#_4-3-获取多个不连续的字符","children":[]}]}],"git":{"createdTime":1711698165000,"updatedTime":1711943871000,"contributors":[{"name":"Lxj679","email":"2944170474@qq.com","commits":9}]},"readingTime":{"minutes":6.77,"words":2031},"filePathRelative":"Notability/python/4.str-Notebook.md","localizedDate":"2024年3月29日","excerpt":"<h2>1. 字符串的定义</h2>\\n<p>字符串是由字母、数字和特殊字符来组成的序列</p>\\n<figure><figcaption>a4034a755a9502dce168bbee003b2cc</figcaption></figure>\\n<h2>2. 创建字符串</h2>\\n<p>如何创建字符串？</p>\\n<p>————使用**<span style=\\"color : orange\\"> 单引号、双引号</span><strong>或者</strong><span style=\\"color : orange\\"> 三引号</span>**。</p>\\n<div class=\\"language-python\\" data-ext=\\"py\\" data-title=\\"py\\"><pre class=\\"language-python\\"><code>name <span class=\\"token operator\\">=</span> <span class=\\"token string\\">'ryan'</span>\\nnumber <span class=\\"token operator\\">=</span> <span class=\\"token string\\">'8'</span>\\nparagraph <span class=\\"token operator\\">=</span> <span class=\\"token triple-quoted-string string\\">'''hello, ryan.\\nnice to meet u'''</span>\\nparagraph_two  <span class=\\"token operator\\">=</span> <span class=\\"token triple-quoted-string string\\">\\"\\"\\"Hi, ryan\\nnice to meet u 2\\"\\"\\"</span>\\n</code></pre></div>","autoDesc":true}`);export{I as comp,P as data};
